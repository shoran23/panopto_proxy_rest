...
async def post_recording_state_route(room_name):
    ...
    # print(data_request)
    # print(data_request.decode("utf-8").split("GET")[0])
    request_dict = data_request.decode("utf-8").split("POST")[0] # cleaning up received byte string
    # print(request_dict)
    # print(type(data_request.decode("utf-8")))
    request_dict = eval(request_dict)
    print("Received requested_state: ", request_dict)
    print(type(request_dict))
    match request_dict:
        case {"requested_state": "recording"}: # was a GET ?
        ...
        case {"requested_state": "previewing"}: # temp testing, will revert to "stop"
        # case {"requested_state": "stop"}:
            ...
            return str(data).encode()
        case {"requested_state": "extend"}: # Fully functional
